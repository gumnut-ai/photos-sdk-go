...
func TestUserAgentHeader(t *testing.T) {
	...
	if userAgent != fmt.Sprintf("GumnutAI/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Albums.New(context.Background(), photos.AlbumNewParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Albums.New(cancelCtx, photos.AlbumNewParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Albums.New(deadlineCtx, photos.AlbumNewParams{})
		if err == nil {
