...
func TestPersonNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.People.New(context.TODO(), photos.PersonNewParams{
		BirthDate:       photos.Time(time.Now()),
		IsFavorite:      photos.Bool(true),
		IsHidden:        photos.Bool(true),
		LibraryID:       photos.String("library_id"),
		Name:            photos.String("name"),
		ThumbnailFaceID: photos.String("thumbnail_face_id"),
	})
	if err != nil {
...
func TestPersonListWithOptionalParams(t *testing.T) {
	...
	_, err := client.People.List(context.TODO(), photos.PersonListParams{
		...
		Limit:           photos.Int(1),
		Name:            photos.String("name"),
		NameFilter:      photos.PersonListParamsNameFilterNamed,
...
func TestPersonMerge(t *testing.T) {
	...
	_, err := client.People.Merge(
		context.TODO(),
		"person_id",
		photos.PersonMergeParams{
			SourcePersonIDs: []string{"string"},
		},
	)
	if err != nil {
		var apierr *photos.Error
